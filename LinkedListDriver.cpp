...
int main()
{
	...
	//Testing merge(LinkedList<T> &list1, LinkedList<T> &list2)
	std::cout << "Testing merge(LinkedList<T> &list1, LinkedList<T> &list2)" << std::endl;
	LinkedList<int>::merge(*list1, *list2, *merge);
	merge->print();
	std::cin.get();
