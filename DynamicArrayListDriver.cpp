...
int main()
{
	DynamicArrayList<int> *list1 = new DynamicArrayList<int>();
	DynamicArrayList<int> *list2 = new DynamicArrayList<int>();
	DynamicArrayList<int> *merge = new DynamicArrayList<int>();
	...
	//Testing merge(DynamicArrayList<T> &list1, DynamicArrayList<T> &list2)
	std::cout << "Testing merge(DynamicArrayList<T> &list1, DynamicArrayList<T> &list2)" << std::endl;
	DynamicArrayList<int>::merge(*list1, *list2, *merge);
	merge->print();
	std::cin.get();
