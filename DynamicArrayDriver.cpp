...
int main()
{
	DynamicArray<int> *list1 = new DynamicArray<int>();
	DynamicArray<int> *list2 = new DynamicArray<int>();
	DynamicArray<int> *merge = new DynamicArray<int>();
	...
	//Testing merge(DynamicArray<T> &list1, LinkedList<T> &list2)
	std::cout << "Testing merge(DynamicArray<T> &list1, DynamicArray<T> &list2)" << std::endl;
	DynamicArray<int>::merge(*list1, *list2, *merge);
	merge->print();
	std::cin.get();
